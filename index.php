        ...
        <div class="row align-items-center g-5">
            <div class="col-12 col-md-6 text-center text-md-start">
                ...
                <p class="lead text-muted mb-4" style="font-weight: 400; line-height: 1.7;">
                    LMS Sukses adalah platform LMS (Learning Management System) seperti e-Lok yang dirancang khusus untuk mempermudah mahasiswa TRPL menguasai materi perkuliahan, quiz, dan ujian.
                </p>
            ...
            <div class="col-12 col-md-6">
                <div class="p-5 bg-white border rounded-4 shadow-sm text-center">
                    <div class="py-5">
                        <span class="display-1 text-dark fw-bold">LMS.<span class="text-primary">Sukses</span></span>
                        <p class="text-secondary mt-3 mb-0 font-monospace">Liat Materi, Sleep. Sukses</p>
                    </div>
                </div>
            </div>
        </div>
